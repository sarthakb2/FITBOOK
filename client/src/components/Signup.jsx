      ...
      <div className=' w-full h-screen flex flex-col items-center mt-8 '>
        <div className='border-2 rounded-lg bg-white  border-slate-200 pr-20 pl-20 pt-4 mt-8 mb-8 flex flex-col  items-center'> 
          ...
          <h1 className=' text-blue-800 text-3xl font-semibold mt-8 mb-2'>
            ...
            <input type="text" placeholder='username' className='bg-white-800 border-2 w-80 text-black rounded-lg p-2 m-2 outline-none' />
            <input type="text" placeholder='password' className='bg-white-800 border-2 w-80 text-black rounded-lg p-2 m-2 outline-none' />
            <input type="text" placeholder='email' className='bg-white-800 border-2 w-80 text-black rounded-lg p-2 m-2 outline-none' />
            <input type="text" placeholder='state' className='bg-white-800 border-2 w-80 text-black rounded-lg p-2 m-2 outline-none' />
            <input type="text" placeholder='city' className='bg-white-800 border-2 w-80 text-black rounded-lg p-2 m-2 outline-none' />
            <input type="text" placeholder='postalArea' className='bg-white-800 border-2 w-80 text-black rounded-lg p-2 m-2 mb-5 outline-none' />
